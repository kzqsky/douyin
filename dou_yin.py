...
def save_video_met():
    ...
    """
    # 分享
    os.system("adb shell input tap 1000 1720")
    time.sleep(0.05)

    # 保存到本地
    os.system("adb shell input tap 350 2000")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        while True:
            ...
            screen_name = get_screen_shot_part_img('G:/images/temp%d.jpg' % recognite_count)
